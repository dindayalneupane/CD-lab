...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_stmt_block = 16,                /* stmt_block  */
  YYSYMBOL_cond = 17,                      /* cond  */
...
{
      10,    17,     1,    11,    18,     1,     5,    12,     4,     6,
       9,     8,    16,     3,    15,     0,    20,     0,    21
};

static const yytype_int8 yycheck[] =
{
       5,     5,     3,     8,     8,     3,     0,     5,    11,     5,
      12,     6,     4,     0,     7,    -1,    16,    -1,     9
};
...
{
       0,     3,    14,    15,    11,     0,     5,    17,     6,    12,
       5,     8,     5,    15,    16,     7,     4,     5,     8,    18,
      16,     9
};
...
#line 1088 "ifelse.tab.c"
    break;


#line 1092 "ifelse.tab.c"
...
void yyerror(const char *s)
{
    ...
    /* Flush remaining tokens on the current line */
    while (yylex() != 0)
        ;
}
